...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        // 012345678
        String text = "Good";
        System.out.println("G harfinin indexi = " + text.indexOf("G")); // indexler 0 dan başlar --> Cift tirnak ile string parametre verdik
        System.out.println("d harfinin indexi = " + text.indexOf('d')); //3 --> Tek tirnak ile char parametre verdik
        ...
        //String parametresi birden fazla char'in birlesiminden olusuyor ise, ilk char'in indexini dondurur
       
        int index = text.indexOf("o"); // int değişkene atanabilir. küçük o harfi
        // methodun dondurdugu degeri dogrudan sout icerisinde yazdirabildigimiz gibi, uygun ver tipinde olusturulmus bir degiskene de atayabiliriz
         ...
         *  Burada kafan karismasin, aradigin karakteri sondan baslayarak arayacaksin, buldugunda indeksini bastan sayarak bulacaksin
         *  Index daima bastan sayilarak bulunur, asla sondan sayilmaz 
         ...
         * Metin icerisinde, istenilen indexteki karaktere ulasimi saglar. Integer deger alir, Sonuc char dir.
         *  0123456789012
         */
         ...
         * substring'i parcalamak olarak dusunebilirsin.
         * ss.substring --> ss i parcala demek, neye gore parcala, girilen parametreye gore parcala
         */

        String ss= "Her ders Java gibi olsa";

        // SUBSTRING TEKIL PARAMETRE ALDIGINDA //
        System.out.println(ss.substring(10)); // ava gibi olsa: 10.index dahil(inclusive) sonuna kadar tum String 
        // --> sabit bir deger verir, hangi kelime girilirse girilsin daima 10. indeksteki char'a gore parcalama yapacak
        System.out.println(ss.substring(ss.length()-10)); // gibi olsa: son 10 harfi yazdirin
        // --> Dynamic bir deger verir. Girilen kelimenin uzunluguna gore parcalama yapacagi indeks degisir, 
        //     sabit olan tek sey daima son 10 karakteri verecek olmasidir, olusacak substringin length'i daima 10 olacak

        // SUBSTRING COKLU PARAMETRE ALDIGINDA
        // ilk 10 karakteri alma
        System.out.println(ss.substring(0, 10));//Her ders J: substring(0, 10) yazildiginda
        // 0 inclusive, 10 exclusive -->  ilk karakter dahil son karakter dahil degil tipki matematikteki gibi
        System.out.println(ss.substring(2, 3)); // trick! burada 2 dahil 3 haric oldugu icin aslinda ss.charAt(2) ile ayni seyi istemis oluyor
        // ss.substring(2) ile ayni sey degil, cunku bu ifade 2 den baslayipo sona kadar devam ediyor, hic durmuyor, 
        // tek bir karakteri yazip cikmiyor, tek karakteri yazan charAt() methodudur
        
        // 11.ci karakterden sonuna kadar olan Stringi yazdiralim (trick)
        System.out.println(ss.substring(10));//ava gibi olsa
        // 11. karakterin indeksi 10'dur (indeksler 0'dan basladigi icin). DİKKAT!!
        ...
        // hem 10'u al hem de 10'u alma diyoruz. 

        //System.out.println(str.substring(8, 7)); // RTE
        // java soldan saga dogru calistigi icin indeksler artarak ilerlemek zorundadir

        System.out.println(ss.substring(22)); //cıktı:a --> length()-1 -> son karakter
        System.out.println(ss.substring(23)); //bosluk ...length() -> bos. length 23 oldugu icin bu kod calisacak ama yazdiracak hicbir sey bulamayacaktir
        //System.out.println(ss.substring(24)); // length()'den buyuk sayi yazarsak RTE
         ...
         * Hem char hem de string alabilir
         *
         */
        ...
        * Replace ile aynı sadece ilk bulunanı değiştirir
         ...
         * parametre olarak string alir, char almaz!
         * Sonuc boolean dir.
         *
         * equals()
        ...
        // Bunlar iki ayri degiskenlerdir. Hafizadaki yerler dolayisiyla reference degerleri farklidir.
        // equals() degiskenlerin reference degerlerini karsilastirarak islem yapar
