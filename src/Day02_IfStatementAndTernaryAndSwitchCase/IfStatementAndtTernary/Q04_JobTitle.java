...
public class Q04_JobTitle {
	...
	public static void main(String[] args) {
		...
		// equalsIgnoreCase() methodu case sensitive ozelligini devre disi birakarak karsilastirma yapar
		// yani buyuk kucuk harf farkina bakmaksizin ifadelerin esit olup olmadigini karsilastirir
